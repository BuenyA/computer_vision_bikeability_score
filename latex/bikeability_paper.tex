...
natural language supervision,'' in \emph{Proc. Int. Conf. Machine
Learning (ICML)}, 2021, pp. 8748--8763.

\bibitem{openclip}
G. Ilharco \emph{et al.}, ``OpenCLIP,'' Zenodo, 2021.
[Online]. Available: \url{https://github.com/mlfoundations/open_clip}

\bibitem{siglip}
X. Zhai, B. Mustafa, A. Kolesnikov, and L. Beyer, ``Sigmoid loss for
language image pre-training,'' in \emph{Proc. IEEE/CVF Int. Conf.
Computer Vision (ICCV)}, 2023, pp. 11975--11986.

\bibitem{mobileclip}
P. K. A. Vasu \emph{et al.}, ``MobileCLIP: Fast image-text models
through multi-modal reinforced training,'' in \emph{Proc. IEEE/CVF Conf.
Computer Vision and Pattern Recognition (CVPR)}, 2024.

\bibitem{evaclip}
Q. Sun, Y. Fang, L. Wu, X. Wang, and Y. Cao, ``EVA-CLIP: Improved
training techniques for CLIP at scale,'' \emph{arXiv preprint
arXiv:2303.15389}, 2023.

\bibitem{datacomp}
S. Y. Gadre \emph{et al.}, ``DataComp: In search of the next generation
of multimodal datasets,'' in \emph{Proc. Advances in Neural Information
Processing Systems (NeurIPS)}, 2023.

\bibitem{dinov2}
M. Oquab \emph{et al.}, ``DINOv2: Learning robust visual features
without supervision,'' \emph{Trans. Machine Learning Research (TMLR)},
2024.
